...
(function(root, factory) {
	...
	Adb.WebUSB.Device.prototype.forward = function(command="") {
		return Adb.Stream.open(this, "host::forward:" + command);
	};

	Adb.WebUSB.Device.prototype.reverse = function(command="") {
		return Adb.Stream.open(this, "reverse:" + command);
	};

	Adb.WebUSB.Device.prototype.tcp = function(command="") {
		return Adb.Stream.open(this, "tcp:" + command);
	};
